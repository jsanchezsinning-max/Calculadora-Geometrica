...
while option != 10:
    ...
    if option == 1:
        ...
        rectangulo = int(input("Que deseas calcular?: "))
        ...
        triangulo = int(input("Que deseas calcular?: "))
        ...
        pentagono = int(input("Que deseas calcular?: "))
        ...
        prisma = int(input("Que deseas calcular?: "))
        ...
        esfera = int(input("Que deseas calcular?: "))
        ...
        cilindro = int(input("Que deseas calcular?: "))
        ...
        cono = int(input("Que deseas calcular?: "))
        ...
        triangulo_r = int(input("Que deseas calcular?: "))
